...
document.addEventListener("DOMContentLoaded", () =>{
    ...
    const forms = document.querySelectorAll("form");
        ...
        const postData = async (url, data) =>{ // у нас от сервера могут приходить ответы в различных форматах,
            ...
            // мы не знаем сколько времени нам надо чтобы перевести джейсоновский объект в обычный, и мы
            // говорим чтобы оно вернуло нам обычный объект как только его переведет
        };
